...
export class UserService {
  ...
  getUsers(
    ...
    const paginatedResult: PaginatedResult<IUser[]> = new PaginatedResult<
      IUser[]
    >();
  ...
  getMessages(id: number, page?, itemsPerPage?, messageContainer?) {
    const paginatedResult: PaginatedResult<IMessage[]> = new PaginatedResult<
      IMessage[]
    >();
    ...
    return this.http
      .get<IMessage[]>(this.baseUrl + 'users/' + id + '/messages', {
        observe: 'response',
        params,
      })
      .pipe(
